...
namespace BTN_10_SO_26
{
    public partial class frmHoaDonNhap : Form
    {
        ...
        private void FillDataToCombo1()
        {
            ...
            /*sql = "select SoHDN from HoaDonNhap";
            DAO.FillDataToCombo(sql, cmbTim, "SoHDN", "SoHDN");*/
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!DAO.CheckKeyExit(sql))
            {
                ...
                dgt = Convert.ToDouble(DAO.GetFieldValues("SELECT DonGiaNhap FROM DMNoiThat WHERE MaNoiThat = N'" + cmbMaNoiThat.SelectedValue + "'"));
                if (dg != dgt)
                {
                ...
                dgb = dg * 1.1;
                sql = "UPDATE DMNoiThat SET DonGiaBan =" + dgt + " WHERE MaNoiThat= N'" + cmbMaNoiThat.SelectedValue + "'";
                DAO.RunSQL(sql);
        ...
        private void cmbMaNoiThat_TextChanged(object sender, EventArgs e)
        {
            ...
            txtDonGia.Text = DAO.GetFieldValues(str);
            /*str = "SELECT SoLuong FROM ChiTietDonDatHang WHERE MaNoiThat =N'" + cmbMaNoiThat.SelectedValue + "'";
            txtSoLuong.Text = DAO.GetFieldValues(str);
            str = "SELECT GiamGia FROM ChiTietDonDatHang WHERE MaNoiThat =N'" + cmbMaNoiThat.SelectedValue + "'";
            txtGiamGia.Text = DAO.GetFieldValues(str);
            str = "SELECT ThanhTien FROM ChiTietDonDatHang WHERE MaNoiThat =N'" + cmbMaNoiThat.SelectedValue + "'";
            txtThanhTien.Text = DAO.GetFieldValues(str);
            str = "SELECT TongTien FROM ChiTietHoaDonNhap as a inner join HoaDonNhap as b on a.SoHDN=b.SoHDN WHERE MaNoiThat =N'" + cmbMaNoiThat.SelectedValue + "'";
            txtTongTien.Text = DAO.GetFieldValues(str);
            // lbBangChu.Text = "Bằng chữ: " + DAO.ChuyenSoSangChu(Double.Parse(txtTongTien.Text));
            str = "SELECT MaNV FROM ChiTietHoaDonNhap  as a inner join HoaDonNhap as b on a.SoHDN=b.SoHDN WHERE MaNoiThat = N'" + cmbMaNoiThat.SelectedValue + "'";
            cmbMaNV.Text = DAO.GetFieldValues(str);
            str = "SELECT TenNV FROM NhanVien as a inner join HoaDonNhap as b on a.MaNV=b.MaNV inner join ChiTietHoaDonNhap as c on c.SoHDN=b.SoHDN WHERE MaNoiThat = N'" + cmbMaNoiThat.SelectedValue + "'";
            txtTenNV.Text = DAO.GetFieldValues(str);
            str = "SELECT MaNCC FROM HoaDonNhap as b inner join ChiTietHoaDonNhap as c on c.SoHDN=b.SoHDN WHERE MaNoiThat = N'" + cmbMaNoiThat.SelectedValue + "'";
            cmbMaNCC.Text = DAO.GetFieldValues(str);
            str = "SELECT TenNCC FROM NhaCungCap as a inner join HoaDonNhap as b on a.MaNCC=b.MaNCC inner join ChiTietHoaDonNhap as c on c.SoHDN=b.SoHDN WHERE MaNoiThat = N'" + cmbMaNoiThat.SelectedValue + "'";
            txtTenNCC.Text = DAO.GetFieldValues(str);
            str = "SELECT DiaChi FROM NhaCungCap as a inner join HoaDonNhap as b on a.MaNCC=b.MaNCC inner join ChiTietHoaDonNhap as c on c.SoHDN=b.SoHDN WHERE MaNoiThat = N'" + cmbMaNoiThat.SelectedValue + "'";
            txtDiaChi.Text = DAO.GetFieldValues(str);
            str = "SELECT DienThoai FROM NhaCungCap as a inner join HoaDonNhap as b on a.MaNCC=b.MaNCC inner join ChiTietHoaDonNhap as c on c.SoHDN=b.SoHDN WHERE MaNoiThat = N'" + cmbMaNoiThat.SelectedValue + "'";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                string sql = "SELECT MaNoiThat,SoLuong FROM ChiTietHoaDonNhap WHERE SoHDN = N'" + txtSoHDN.Text + "'";
                DataTable SanPham = DAO.GetDataToTable(sql);
                for (int sanpham = 0; sanpham <= SanPham.Rows.Count - 1; sanpham++)
                {
                    // Cập nhật lại số lượng cho các mặt hàng
                    sl = Convert.ToDouble(DAO.GetFieldValues("SELECT SoLuong FROM DMNoiThat WHERE MaNoiThat = N'" + SanPham.Rows[sanpham][0].ToString() + "'"));
                    slxoa = Convert.ToDouble(SanPham.Rows[sanpham][1].ToString());
                    slcon = sl + slxoa;
                    sql = "UPDATE DMNoiThat SET SoLuong =" + slcon + " WHERE MaNoiThat= N'" + SanPham.Rows[sanpham][0].ToString() + "'";
                    DAO.RunSQL(sql);
                }

                //Xóa chi tiết hóa đơn
                sql = "DELETE ChiTietHoaDonNhap WHERE SoHDN=N'" + txtSoHDN.Text + "'";
                DAO.RunSQL(sql);
